...
class HouseFeatures(BaseModel):
    bedrooms: float; bathrooms: float; sqft_living: float; sqft_lot: float; floors: float
    waterfront: float; view: float; condition: float; grade: float; sqft_above: float
    sqft_basement: float; yr_built: float; yr_renovated: float; zipcode: float
    lat: float; long: float; sqft_living15: float; sqft_lot15: float
...
def predict(req: PredictIn):
    x = req.features
    ordered = [x.bedrooms, x.bathrooms, x.sqft_living, x.sqft_lot, x.floors,
