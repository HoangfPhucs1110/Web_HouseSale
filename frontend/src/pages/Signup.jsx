  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <input name="name" placeholder="Họ tên" className="border p-3 rounded-lg" onChange={handleChange} required />
      ...
      <div className="flex gap-2 mt-5 justify-center">
        <p>Đã có tài khoản?</p>
        <Link to="/signin"><span className="hover:underline">Đăng nhập</span></Link>
      </div>
